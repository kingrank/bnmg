...
<body>
    <div class="layui-tab">
        <fieldset class="layui-elem-field layui-field-title" style="margin-top: 20px;">
            <legend>当前选择部门：<label id="departname" style="color:#009688">未选择部门</label></legend>
        </fieldset>
        <ul class="layui-tab-title">
            <li class="layui-this">管理员操作</li>
            <li>商户操作</li>
        </ul>
                ...
                <script type="text/html" id="toolbarDemo">
                    <div class="layui-btn-container">
                       <%-- <button class="layui-btn layui-btn-sm" lay-event="getCheckData">获取选中行数据</button>
                        ...
                        <button class="layui-btn layui-btn-sm" lay-event="updateDepart">部门变更</button>
...
<script src="${context}/resource/js/admin/departOther.js" type="text/javascript"></script>
<script>
