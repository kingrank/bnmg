        ...
        <div class="layui-card" style="background-color: #fff;height:90%;font-size:12px;font-weight:400;color:#333333;line-height:30px;">
            ...
            <div class="layui-card-body" style="font-size: 20px;">
                <form class="layui-form" action="">
                    <div class="layui-row">
                        <div class="layui-col-sm2" style="padding: 6px 0px;color: #8894B2;text-align: right;"> 支付宝支付： </div>
                    ...
                    <div class="layui-row">
                        <div class="layui-col-sm2" style="padding: 6px 0px;color: #8894B2;text-align: right;"> 微信支付：</div>
                        <div class="layui-col-sm8">
                            <div class="layui-input-block">
                                <input type="checkbox" name="close" lay-skin="switch" lay-text="ON|OFF">
                            </div>
                    ...
                    <div class="layui-row">
                        <div class="layui-col-sm2" style="padding: 6px 0px;color: #8894B2;text-align: right;"> 银联支付：</div>
                        <div class="layui-col-sm8">
                            <div class="layui-input-block">
                                <input type="checkbox" name="close" lay-skin="switch" lay-text="ON|OFF">
                            </div>
...
<link rel="stylesheet" href="${context}/resource/css/merchant/mer_pay.css">
<script src="${context}/resource/js/merchant/mer_pay.js" type="text/javascript"></script>
<script>
